...
export const CategoryDeleteDialog = (props: ICategoryDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="insApplicationApp.category.delete.question">
        <Translate contentKey="insApplicationApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
