...
export const PaiementDeleteDialog = (props: IPaiementDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="insApplicationApp.paiement.delete.question">
        <Translate contentKey="insApplicationApp.paiement.delete.question" interpolate={{ id: paiementEntity.id }}>
