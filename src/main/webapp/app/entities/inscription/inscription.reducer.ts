...
export const ACTION_TYPES = {
  ...
  PARTIAL_UPDATE_INSCRIPTION: 'inscription/PARTIAL_UPDATE_INSCRIPTION',
...
export default (state: InscriptionState = initialState, action): InscriptionState => {
  switch (action.type) {
    ...
    case REQUEST(ACTION_TYPES.PARTIAL_UPDATE_INSCRIPTION):
      return {
        ...state,
        errorMessage: null,
        updateSuccess: false,
    ...
    case FAILURE(ACTION_TYPES.PARTIAL_UPDATE_INSCRIPTION):
    ...
    case SUCCESS(ACTION_TYPES.PARTIAL_UPDATE_INSCRIPTION):
      return {
        ...state,
        updating: false,
        updateSuccess: true,
...
export const partialUpdate: ICrudPutAction<IInscription> = entity => async dispatch => {
  const result = await dispatch({
    type: ACTION_TYPES.PARTIAL_UPDATE_INSCRIPTION,
