...
class SalleResourceIT {
    ...
    public static Salle createEntity(EntityManager em) {
        Salle salle = new Salle().code(DEFAULT_CODE).batiment(DEFAULT_BATIMENT).etage(DEFAULT_ETAGE);
        return salle;
    }
    ...
    public static Salle createUpdatedEntity(EntityManager em) {
        Salle salle = new Salle().code(UPDATED_CODE).batiment(UPDATED_BATIMENT).etage(UPDATED_ETAGE);
        return salle;
    }
    ...
    void createSalle() throws Exception {
        ...
        assertThat(testSalle.getBatiment()).isEqualTo(DEFAULT_BATIMENT);
    ...
    @Test
    @Transactional
    void checkBatimentIsRequired() throws Exception {
        int databaseSizeBeforeTest = salleRepository.findAll().size();
        // set the field null
    ...
    @Test
    @Transactional
    void checkEtageIsRequired() throws Exception {
        int databaseSizeBeforeTest = salleRepository.findAll().size();
        // set the field null
        salle.setEtage(null);
    ...
    void putNewSalle() throws Exception {
        ...
        updatedSalle.code(UPDATED_CODE).batiment(UPDATED_BATIMENT).etage(UPDATED_ETAGE);
        ...
        assertThat(testSalle.getBatiment()).isEqualTo(UPDATED_BATIMENT);
    ...
    void partialUpdateSalleWithPatch() throws Exception {
        ...
        partialUpdatedSalle.code(UPDATED_CODE).batiment(UPDATED_BATIMENT);
    ...
    void fullUpdateSalleWithPatch() throws Exception {
        ...
        partialUpdatedSalle.code(UPDATED_CODE).batiment(UPDATED_BATIMENT).etage(UPDATED_ETAGE);
